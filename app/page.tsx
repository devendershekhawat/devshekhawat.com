...
export default async function Home() {
  return (
    <main className="min-h-screen bg-[url('/herobg.gif')] bg-fixed bg-no-repeat bg-center bg-cover">
      <div className="bg-slate-800/70 min-h-screen lg:py-10">
        <div className="max-w-[1024px] mx-auto md:pt-20 bg-slate-900/80 px-6 py-4">
          <div className="grid grid-cols-6 gap-10">
            ...
            <div className="col-span-6 md:col-span-4">
              ...
              <div className="text-gray-300 text-l [&>p]:my-4 leading-8">
                <p>
